  ...
  return (
    <div style={{ backgroundColor: '#050543' }}>
      <Container sx={{ padding: '20px' }}>
        <Grid container spacing={3} justifyContent='center' sx={{ paddingTop: '15px' }} >
          <Grid item lg={4} md={4} xs={12}>
            <Box sx={{ textAlign: 'left', height: '38px' }}>
              <Typography variant='subtitle1' sx={{ color: '#fff5f1' }}>
                NUST Delta Building
              </Typography>
            </Box>
            <Box sx={{ textAlign: 'left', height: '38px' }}>
          ...
          <Grid item lg={4} md={4} xs={12}>
            <Grid container justifyContent='left'>
              ...
              <Grid item xs={6}>
                <Box sx={{ textAlign: 'left', height: '38px' }}>
                  <a className='link' target='_blank' rel='noreferrer' href='https://nust.ac.zw'>NUST</a>
                </Box>
                <Box sx={{ textAlign: 'left', height: '38px' }}>
                  <a className='link' target='_blank' rel='noreferrer' href='https://saywhat.org'>SAYWHAT</a>
                </Box>

                <Box sx={{ textAlign: 'left', height: '38px' }}>
                  <a className='link' target='_blank' rel='noreferrer' href='https://friendshipbench.org'>Friendship Bench</a>
                </Box>
              </Grid>

              <Grid item xs={6}>
                <Box sx={{ textAlign: 'left', height: '38px' }}>
                  <Link to='/blog' target='_blank' rel='noreferrer' style={{ textDecoration: 'none', height: '38px' }}>
                    <Typography variant='subtitle1' sx={{ color: '#fff5f1', textAlign: 'left', ':hover': { color: '#f36a11' } }}>
                      Blog
                    </Typography>
                  </Link>
                </Box>
      ...
      <div style={{ backgroundColor: '#333' }}>
        <Container maxWidth='sm' sx={{ paddingTop: '10px' }}>
          <Typography variant='subtitle2' align='center' sx={{ color: '#fff' }}>
            The Choice Champions © {new Date().getFullYear()}. All right reserved.  <a style={{ color: '#fff' }} target='_blank' rel='noreferrer' href='https://munashe.co.zw'>SiDesigned</a>
          </Typography>
        </Container>
        <br />
      </div>
